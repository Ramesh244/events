...
class Events extends Component {
  ...
  getActiveRegistrationStatus = () => {
    ...
    const activeEventDeatils = eventsList.find(
      event => event.id === activeEventId,
    )
    if (activeEventDeatils) {
      return activeEventDeatils.registrationStatus
    }
    return ''
  }
    ...
    return (
      <div className="event-container">
        ...
        <ActiveEventRegistrationDetails
          activeEventRegistrationSatus={this.getActiveRegistrationStatus()}
        />
      </div>
    )
  }
